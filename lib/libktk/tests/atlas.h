...
enum { ATLAS_WHITE = KTK_ICON_MAX, ATLAS_FONT };
...
static ktk_Rect atlas[] = {
  [ KTK_ICON_CLOSE ] = { 88, 68, 16, 16 },
  [ KTK_ICON_CHECK ] = { 0, 0, 18, 18 },
  [ KTK_ICON_EXPANDED ] = { 118, 68, 7, 5 },
  [ KTK_ICON_COLLAPSED ] = { 113, 68, 5, 7 },
