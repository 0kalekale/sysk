/*
	...
	$ gcc example/sysk_helloworld.c _entry.s _sysk.c util.c _syskmem.c _linux/_syscalls.c _linux/_syscall_linux.s -I../../include _linux/_void_syscalls.c  -o test -g
